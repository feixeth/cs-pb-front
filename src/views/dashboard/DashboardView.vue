...
const isReady = computed(() => userStore.isReady)
...
<template>
  <div v-if="isReady" class="container mx-auto px-4 py-10">
    <div class="mb-8">
      ...
      <p v-else class="text-gray-400">Loading user...</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
      ...
      <div class="bg-csGray-800 rounded-lg p-6">
        <div class="flex items-center mb-4">
          <img :src="user?.avatar" alt="Profile" class="h-10 w-10 rounded-full object-cover mr-3" />
        ...
        <div class="mt-4">
          <router-link to="/profile"
            class="text-tacticalGreen-500 hover:text-tacticalGreen-400 text-sm font-medium flex items-center">
            Edit Profile
    ...
    <div class="mb-10">
      ...
      <div v-if="userStrategies.length > 0" class="space-y-4">
        <div v-for="strategy in userStrategies.slice(0, 3)" :key="strategy.id"
      ...
      <div v-else class="bg-csGray-800 rounded-lg p-6 text-center">
        ...
        <p class="mt-1 text-gray-500">Start by creating your first strategy.</p>
        <button @click="createStrategy" class="mt-4 btn-primary">Create First Strategy</button>
      </div>
    </div>
  </div>
